            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 md:gap-6'>
                        ...
                        <input name='phone' type="Phone" required readOnly={user?.phoneNumber} defaultValue={user?.phoneNumber} placeholder="Phone Number" className="input input-bordered w-full" />
